...
export default function Legal() {
  ...
  const integrations = ["Clio", "MyCase", "PracticePanther", "Google Calendar", "Stripe"];
          ...
          <Card className="p-8 mb-16">
            ...
            <div className="flex flex-wrap gap-3">
              {integrations.map((integration, idx) => (
                <div key={idx} className="px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full text-sm" data-testid={`integration-${idx}`}>
                  {integration}
                </div>
              ))}
            </div>
