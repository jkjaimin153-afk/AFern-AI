...
import { Check, ArrowRight, AlertCircle, Users, ShoppingCart } from "lucide-react";
import { motion } from "framer-motion";

const challenges = [
  { icon: AlertCircle, text: "Customer support inquiries overwhelm lean teams during peak seasons" },
  { icon: ShoppingCart, text: "BOPIS and return logistics require manual coordination that doesn&apos;t scale" },
  { icon: Users, text: "Disconnected systems create gaps in order information and customer service" },
];

const managed = [
  "AI voice agents answer calls 24/7, automate order status, and handle returns and exchanges",
  "AI chat agents coordinate BOPIS and curbside pickup, manage returns, and answer product questions",
  "Automated workflows sync orders with Shopify, POS systems, and inventory management tools",
];

const impact = [
  "Reduce average response time to under 1 minute, even during peak seasons",
  "Increase customer satisfaction scores by 25-40%",
  "Free up 20-30 hours per week of support team time",
];
    ...
    <div className="min-h-screen bg-background page-dots">
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="container relative z-10 mx-auto max-w-5xl px-6">
          ...
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl font-semibold text-foreground mb-4">Retail & E-commerce</h1>
            <p className="text-lg text-foreground font-medium max-w-3xl">
              Managed customer communication that automates support, coordinates fulfillment, and scales with order volume.
            </p>
          </div>
