                ...
                {benefits.map((benefit, idx) => (
                  ...
                  >
                    <div className="mt-1 flex-shrink-0">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center glow-purple transition-transform duration-300 group-hover:scale-110">
            ...
            <div className="relative">
              <div className="relative p-8 rounded-2xl glassmorphism border border-white/10">
                ...
                <div className="relative space-y-8">
                  {[
                    { icon: Phone, gradient: "from-accent to-accent/60", width1: "w-3/4", width2: "w-1/2" },
                    { icon: Calendar, gradient: "from-primary to-primary/60", width1: "w-2/3", width2: "w-1/3" },
                    { icon: TrendingUp, gradient: "from-secondary to-secondary/60", width1: "w-4/5", width2: "w-2/5" }
                  ].map((item, idx) => (
                    <div 
                      key={idx}
                    ...
                    >
                      ...
                      <div className="flex-1 space-y-3">
                        <div className={`h-3 bg-gradient-to-r from-accent/40 to-transparent rounded-full ${item.width1}`} />
                        <div className={`h-3 bg-gradient-to-r from-accent/20 to-transparent rounded-full ${item.width2}`} />
                      </div>
                    </div>
                  ))}
                </div>
