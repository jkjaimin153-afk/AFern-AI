    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 relative">
        ...
        <div className="container mx-auto max-w-7xl px-6 relative">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              { value: "98%", label: "Answered calls automatically", testid: "kpi-answered", gradient: "from-primary to-accent", delay: 0 },
              { value: "5", label: "Avg time to booking", testid: "kpi-booking", gradient: "from-secondary to-primary", delay: 0.2 },
              { value: "15+", label: "Businesses onboarded", testid: "kpi-businesses", gradient: "from-accent to-secondary", delay: 0.4 }
            ].map((stat, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <motion.div 
                  className={`text-6xl md:text-7xl font-bold bg-gradient-to-br ${stat.gradient} bg-clip-text text-transparent mb-3`}
            ...
            {features.map((feature, idx) => (
              ...
              >
                ...
                <div className="relative">
                  <motion.div 
                    className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mb-6 glow-purple"
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl px-6 text-center relative z-10">
          <motion.div 
            className="relative p-12 md:p-16 rounded-3xl glassmorphism border border-white/10"
